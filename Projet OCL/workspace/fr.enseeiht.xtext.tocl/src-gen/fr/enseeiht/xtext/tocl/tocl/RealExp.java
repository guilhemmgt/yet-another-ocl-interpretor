 ...
 * </p>
 * <ul>
 *   <li>{@link fr.enseeiht.xtext.tocl.tocl.RealExp#getRealSymbol <em>Real Symbol</em>}</li>
 * </ul>
 *
 * @see fr.enseeiht.xtext.tocl.tocl.ToclPackage#getRealExp()
 * @model
 * @generated
 */
public interface RealExp extends NumericExp
{
   ...
   * @see fr.enseeiht.xtext.tocl.tocl.ToclPackage#getRealExp_RealSymbol()
   * @model
   * @generated
   */
  ...
  /**
   * Sets the value of the '{@link fr.enseeiht.xtext.tocl.tocl.RealExp#getRealSymbol <em>Real Symbol</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
