 ...
 * @generated
 */
public interface ToclFactory extends EFactory
{
  /**
   ...
   * @generated
   */
  ToclFactory eINSTANCE = fr.enseeiht.xtext.tocl.tocl.impl.ToclFactoryImpl.init();
  ...
  /**
   * Returns a new object of class '<em>Ocl Module Element</em>'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @return a new object of class '<em>Ocl Module Element</em>'.
   * @generated
   */
