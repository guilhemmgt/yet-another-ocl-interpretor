 ...
 * </p>
 * <ul>
 *   <li>{@link fr.enseeiht.xtext.tocl.tocl.impl.SetExpImpl#getElements <em>Elements</em>}</li>
 * </ul>
 *
 * @generated
 */
public class SetExpImpl extends OclExpressionImpl implements SetExp
{
  ...
  {
    return ToclPackage.Literals.SET_EXP;
  }
  ...
  public EList<OclExpression> getElements()
  {
    if (elements == null)
    {
      elements = new EObjectContainmentEList<OclExpression>(OclExpression.class, this, ToclPackage.SET_EXP__ELEMENTS);
    }
    return elements;
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case ToclPackage.SET_EXP__ELEMENTS:
