 ...
 * </p>
 * <ul>
 *   <li>{@link fr.enseeiht.xtext.tocl.tocl.impl.MapExpImpl#getElements <em>Elements</em>}</li>
 * </ul>
 *
 * @generated
 */
public class MapExpImpl extends OclExpressionImpl implements MapExp
{
  ...
  {
    return ToclPackage.Literals.MAP_EXP;
  }
  ...
  public EList<MapElement> getElements()
  {
    if (elements == null)
    {
      elements = new EObjectContainmentEList<MapElement>(MapElement.class, this, ToclPackage.MAP_EXP__ELEMENTS);
    }
    return elements;
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case ToclPackage.MAP_EXP__ELEMENTS:
