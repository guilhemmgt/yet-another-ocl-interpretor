...
public class InternalOclLexer extends Lexer {
    ...
    public final void mRULE_DOUBLE() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalOcl.g:11836:13: ( ( RULE_INT '.' RULE_INT | '.' RULE_INT | RULE_INT '.' ) ( 'e' ( '-' | '+' ) RULE_INT )? )
            // InternalOcl.g:11836:15: ( RULE_INT '.' RULE_INT | '.' RULE_INT | RULE_INT '.' ) ( 'e' ( '-' | '+' ) RULE_INT )?
            {
            // InternalOcl.g:11836:15: ( RULE_INT '.' RULE_INT | '.' RULE_INT | RULE_INT '.' )
            int alt1=3;
            alt1 = dfa1.predict(input);
            switch (alt1) {
                case 1 :
                    // InternalOcl.g:11836:16: RULE_INT '.' RULE_INT
                    {
                    mRULE_INT(); 
                    match('.'); 
                    mRULE_INT(); 
                    ...
                    break;
                case 2 :
                    // InternalOcl.g:11836:38: '.' RULE_INT
                    {
                    match('.'); 
                    mRULE_INT(); 
                    ...
                    break;
                case 3 :
                    // InternalOcl.g:11836:51: RULE_INT '.'
                    {
                    mRULE_INT(); 
                    match('.'); 
            ...
            // InternalOcl.g:11836:65: ( 'e' ( '-' | '+' ) RULE_INT )?
            int alt2=2;
            ...
            switch (alt2) {
                case 1 :
                    // InternalOcl.g:11836:66: 'e' ( '-' | '+' ) RULE_INT
                    {
                    match('e'); 
    ...
    public final void mRULE_SL_COMMENT() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalOcl.g:11838:17: ( '--' ( . )* '\\n' )
            // InternalOcl.g:11838:19: '--' ( . )* '\\n'
            {
            match("--"); 

            // InternalOcl.g:11838:24: ( . )*
            loop3:
            do {
                int alt3=2;
    ...
    public final void mRULE_ID() throws RecognitionException {
        try {
            int _type = RULE_ID;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalOcl.g:11840:9: ( ( '^' )? ( 'a' .. 'z' | 'A' .. 'Z' | '_' ) ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '0' .. '9' )* )
            // InternalOcl.g:11840:11: ( '^' )? ( 'a' .. 'z' | 'A' .. 'Z' | '_' ) ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '0' .. '9' )*
            {
            // InternalOcl.g:11840:11: ( '^' )?
            int alt4=2;
            ...
            // InternalOcl.g:11840:40: ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '0' .. '9' )*
            loop5:
            do {
                int alt5=2;
    ...
    public final void mRULE_INT() throws RecognitionException {
        try {
            int _type = RULE_INT;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalOcl.g:11842:10: ( ( '0' .. '9' )+ )
            // InternalOcl.g:11842:12: ( '0' .. '9' )+
            {
            // InternalOcl.g:11842:12: ( '0' .. '9' )+
            int cnt6=0;
            loop6:
    ...
    public final void mRULE_STRING() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalOcl.g:11844:13: ( ( '\"' ( '\\\\' . | ~ ( ( '\\\\' | '\"' ) ) )* '\"' | '\\'' ( '\\\\' . | ~ ( ( '\\\\' | '\\'' ) ) )* '\\'' ) )
            // InternalOcl.g:11844:15: ( '\"' ( '\\\\' . | ~ ( ( '\\\\' | '\"' ) ) )* '\"' | '\\'' ( '\\\\' . | ~ ( ( '\\\\' | '\\'' ) ) )* '\\'' )
            {
            // InternalOcl.g:11844:15: ( '\"' ( '\\\\' . | ~ ( ( '\\\\' | '\"' ) ) )* '\"' | '\\'' ( '\\\\' . | ~ ( ( '\\\\' | '\\'' ) ) )* '\\'' )
            int alt9=2;
            ...
            switch (alt9) {
                case 1 :
                    // InternalOcl.g:11844:16: '\"' ( '\\\\' . | ~ ( ( '\\\\' | '\"' ) ) )* '\"'
                    {
                    match('\"'); 
                    // InternalOcl.g:11844:20: ( '\\\\' . | ~ ( ( '\\\\' | '\"' ) ) )*
                    loop7:
                    do {
                        int alt7=3;
                    ...
                    break;
                case 2 :
                    // InternalOcl.g:11844:48: '\\'' ( '\\\\' . | ~ ( ( '\\\\' | '\\'' ) ) )* '\\''
                    {
                    match('\''); 
                    // InternalOcl.g:11844:53: ( '\\\\' . | ~ ( ( '\\\\' | '\\'' ) ) )*
                    loop8:
                    do {
                        int alt8=3;
    ...
    public final void mRULE_ML_COMMENT() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalOcl.g:11846:17: ( '/*' ( options {greedy=false; } : . )* '*/' )
            // InternalOcl.g:11846:19: '/*' ( options {greedy=false; } : . )* '*/'
            {
            match("/*"); 

            // InternalOcl.g:11846:24: ( options {greedy=false; } : . )*
            loop10:
            do {
                int alt10=2;
    ...
    public final void mRULE_WS() throws RecognitionException {
        try {
            int _type = RULE_WS;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalOcl.g:11848:9: ( ( ' ' | '\\t' | '\\r' | '\\n' )+ )
            // InternalOcl.g:11848:11: ( ' ' | '\\t' | '\\r' | '\\n' )+
            {
            // InternalOcl.g:11848:11: ( ' ' | '\\t' | '\\r' | '\\n' )+
            int cnt11=0;
            loop11:
    ...
    public final void mRULE_ANY_OTHER() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalOcl.g:11850:16: ( . )
            // InternalOcl.g:11850:18: .
            {
            matchAny(); 
    ...
    class DFA1 extends DFA {
        ...
        public String getDescription() {
            return "11836:15: ( RULE_INT '.' RULE_INT | '.' RULE_INT | RULE_INT '.' )";
        }
    }
    static final String DFA12_eotS =
        "\1\uffff\4\61\1\uffff\1\73\1\75\1\100\1\uffff\2\61\1\uffff\1\107\2\61\5\uffff\2\61\2\uffff\4\61\1\uffff\3\61\1\141\2\uffff\4\61\1\151\1\56\1\uffff\2\56\2\uffff\1\61\1\156\1\uffff\1\157\2\61\1\163\1\164\1\61\12\uffff\3\61\3\uffff\3\61\5\uffff\3\61\2\uffff\6\61\1\uffff\5\61\4\uffff\4\61\1\uffff\1\151\2\uffff\1\u008f\2\uffff\1\u0090\1\61\1\u0093\2\uffff\1\61\1\u0095\1\u0096\1\u0097\1\u0098\3\61\1\u009c\4\61\1\u00a2\2\61\1\u00a5\1\u00a6\10\61\2\uffff\2\61\1\uffff\1\61\4\uffff\1\u00b2\1\61\1\u00b4\1\uffff\5\61\1\uffff\2\61\2\uffff\1\u00bc\1\u00bd\1\u00be\3\61\1\u00c2\4\61\1\uffff\1\61\1\uffff\6\61\1\u00ce\3\uffff\1\u00cf\2\61\1\uffff\1\u00d2\1\61\1\u00d4\4\61\1\u00d9\2\61\1\u00dc\2\uffff\2\61\1\uffff\1\u00df\1\uffff\1\u00e0\1\u00e1\1\u00e2\1\61\1\uffff\1\u00e4\1\61\1\uffff\1\61\1\u00e7\4\uffff\1\61\1\uffff\1\u00e9\1\61\1\uffff\1\61\1\uffff\1\61\1\u00ed\1\u00ee\2\uffff";
