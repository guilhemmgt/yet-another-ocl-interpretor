...
public class OclParser extends AbstractContentAssistParser {
	...
	public static final class NameMappings {
		...
		private static void init(ImmutableMap.Builder<AbstractElement, String> builder, OclGrammarAccess grammarAccess) {
			...
			builder.put(grammarAccess.getOclVoidTypeAccess().getGroup(), "rule__OclVoidType__Group__0");
			...
			builder.put(grammarAccess.getEqOpCallExpAccess().getArgsAssignment_0(), "rule__EqOpCallExp__ArgsAssignment_0");
			builder.put(grammarAccess.getEqOpCallExpAccess().getOperationNamesAssignment_1_0(), "rule__EqOpCallExp__OperationNamesAssignment_1_0");
			builder.put(grammarAccess.getEqOpCallExpAccess().getArgsAssignment_1_1(), "rule__EqOpCallExp__ArgsAssignment_1_1");
			builder.put(grammarAccess.getRelOpCallExpAccess().getArgsAssignment_0(), "rule__RelOpCallExp__ArgsAssignment_0");
			builder.put(grammarAccess.getRelOpCallExpAccess().getOperationNamesAssignment_1_0(), "rule__RelOpCallExp__OperationNamesAssignment_1_0");
			builder.put(grammarAccess.getRelOpCallExpAccess().getArgsAssignment_1_1(), "rule__RelOpCallExp__ArgsAssignment_1_1");
			builder.put(grammarAccess.getAddOpCallExpAccess().getArgsAssignment_0(), "rule__AddOpCallExp__ArgsAssignment_0");
			builder.put(grammarAccess.getAddOpCallExpAccess().getOperationNamesAssignment_1_0(), "rule__AddOpCallExp__OperationNamesAssignment_1_0");
			builder.put(grammarAccess.getAddOpCallExpAccess().getArgsAssignment_1_1(), "rule__AddOpCallExp__ArgsAssignment_1_1");
			builder.put(grammarAccess.getIntOpCallExpAccess().getArgsAssignment_0(), "rule__IntOpCallExp__ArgsAssignment_0");
			builder.put(grammarAccess.getIntOpCallExpAccess().getOperationNamesAssignment_1_0(), "rule__IntOpCallExp__OperationNamesAssignment_1_0");
			builder.put(grammarAccess.getIntOpCallExpAccess().getArgsAssignment_1_1(), "rule__IntOpCallExp__ArgsAssignment_1_1");
			builder.put(grammarAccess.getMulOpCallExpAccess().getArgsAssignment_0(), "rule__MulOpCallExp__ArgsAssignment_0");
			builder.put(grammarAccess.getMulOpCallExpAccess().getOperationNamesAssignment_1_0(), "rule__MulOpCallExp__OperationNamesAssignment_1_0");
			builder.put(grammarAccess.getMulOpCallExpAccess().getArgsAssignment_1_1(), "rule__MulOpCallExp__ArgsAssignment_1_1");
			...
			builder.put(grammarAccess.getEnumLiteralExpAccess().getEcoreTypesAssignment_0(), "rule__EnumLiteralExp__EcoreTypesAssignment_0");
			builder.put(grammarAccess.getEnumLiteralExpAccess().getEnum_Assignment_2(), "rule__EnumLiteralExp__Enum_Assignment_2");
			builder.put(grammarAccess.getEnumLiteralExpAccess().getNameAssignment_4(), "rule__EnumLiteralExp__NameAssignment_4");
			...
			builder.put(grammarAccess.getCollectionTypeAccess().getElementTypeAssignment_2(), "rule__CollectionType__ElementTypeAssignment_2");
