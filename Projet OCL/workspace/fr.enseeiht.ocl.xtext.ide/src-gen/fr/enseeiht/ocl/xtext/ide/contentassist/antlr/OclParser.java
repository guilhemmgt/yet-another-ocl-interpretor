...
public class OclParser extends AbstractContentAssistParser {
	...
	public static final class NameMappings {
		...
		private static void init(ImmutableMap.Builder<AbstractElement, String> builder, OclGrammarAccess grammarAccess) {
			...
			builder.put(grammarAccess.getOperatorCallExpAccess().getGroup_1_0(), "rule__OperatorCallExp__Group_1_0__0");
			...
			builder.put(grammarAccess.getOperatorCallExpAccess().getOperationNameAssignment_1_0_1(), "rule__OperatorCallExp__OperationNameAssignment_1_0_1");
			builder.put(grammarAccess.getOperatorCallExpAccess().getArgumentAssignment_1_1(), "rule__OperatorCallExp__ArgumentAssignment_1_1");
