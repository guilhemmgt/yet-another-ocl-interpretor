...
public class OclParser extends AbstractContentAssistParser {
	...
	public static final class NameMappings {
		...
		private static void init(ImmutableMap.Builder<AbstractElement, String> builder, OclGrammarAccess grammarAccess) {
			builder.put(grammarAccess.getOclModuleElementAccess().getMembersAlternatives_1_0(), "rule__OclModuleElement__MembersAlternatives_1_0");
			...
			builder.put(grammarAccess.getOclModuleElementAccess().getGroup(), "rule__OclModuleElement__Group__0");
			builder.put(grammarAccess.getOclModuleElementAccess().getGroup_0(), "rule__OclModuleElement__Group_0__0");
			...
			builder.put(grammarAccess.getModuleAccess().getElementsAssignment_1(), "rule__Module__ElementsAssignment_1");
			builder.put(grammarAccess.getModuleAccess().getElementsAssignment_2(), "rule__Module__ElementsAssignment_2");
			...
			builder.put(grammarAccess.getOclModuleElementAccess().getEcoreTypesAssignment_0_1(), "rule__OclModuleElement__EcoreTypesAssignment_0_1");
			builder.put(grammarAccess.getOclModuleElementAccess().getClassAssignment_0_3(), "rule__OclModuleElement__ClassAssignment_0_3");
			builder.put(grammarAccess.getOclModuleElementAccess().getMembersAssignment_1(), "rule__OclModuleElement__MembersAssignment_1");
