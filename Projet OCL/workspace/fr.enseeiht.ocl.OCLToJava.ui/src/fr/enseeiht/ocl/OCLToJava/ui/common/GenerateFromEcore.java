 ...
 *******************************************************************************/
package fr.enseeiht.ocl.OCLToJava.ui.common;
...
public class GenerateFromEcore {
	...
	public void doGenerate(IProgressMonitor monitor) throws IOException {
		...
		EcoreToJava gen0 = new EcoreToJava(modelURI, oclTargetFolder.getLocation().toFile(), arguments);
		monitor.worked(1);
		...
		if (model != null) {
			...
			monitor.subTask("Loading...");
			OclCollectionToJava gen1 = new OclCollectionToJava(model, oclCollectionTargetFolder.getLocation().toFile(), arguments);
			monitor.worked(1);
