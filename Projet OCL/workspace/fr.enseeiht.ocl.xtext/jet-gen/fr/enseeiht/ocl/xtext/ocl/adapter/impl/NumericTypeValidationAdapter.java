...
public final class NumericTypeValidationAdapter implements OCLAdapter {
  ...
  public Object getValue(EObject contextTarget) {
    throw new UnimplementedException("La methode getValue de NumericTypeAdapter n'as pas encore été implémentée");
  }
  ...
  public OCLType getType() {
    throw new UnimplementedException("La methode getType de NumericTypeAdapter n'as pas encore été implémentée");
  }
