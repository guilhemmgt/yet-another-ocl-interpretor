...
public final class LocalVariableValidationAdapter implements OCLAdapter {
  ...
  public Object getValue(EObject contextTarget) {
    throw new UnimplementedException("La methode getValue de LocalVariableAdapter n'as pas encore été implémentée");
  }
  ...
  public OclType getType() {
    throw new UnimplementedException("La methode getType de LocalVariableAdapter n'as pas encore été implémentée");
  }
