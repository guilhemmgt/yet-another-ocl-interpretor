...
public final class EnumLiteralExpValidationAdapter implements OCLAdapter {
  ...
  public Object getValue(EObject contextTarget) {
    throw new UnimplementedException("La methode getValue de EnumLiteralExpAdapter n'as pas encore été implémentée");
  }
  ...
  public OclType getType() {
    throw new UnimplementedException("La methode getType de EnumLiteralExpAdapter n'as pas encore été implémentée");
  }
