...
public final class TupleTypeValidationAdapter implements OCLAdapter {
  ...
  public Object getValue(EObject contextTarget) {
    throw new UnimplementedException("La methode getValue de TupleTypeAdapter n'as pas encore été implémentée");
  }
  ...
  public OclType getType() {
    throw new UnimplementedException("La methode getType de TupleTypeAdapter n'as pas encore été implémentée");
  }
