...
public final class TupleTypeAttributeValidationAdapter implements OCLAdapter {
  ...
  public Object getValue(EObject contextTarget) {
    throw new UnimplementedException("La methode getValue de TupleTypeAttributeAdapter n'as pas encore été implémentée");
  }
  ...
  public OCLType getType() {
    throw new UnimplementedException("La methode getType de TupleTypeAttributeAdapter n'as pas encore été implémentée");
  }
