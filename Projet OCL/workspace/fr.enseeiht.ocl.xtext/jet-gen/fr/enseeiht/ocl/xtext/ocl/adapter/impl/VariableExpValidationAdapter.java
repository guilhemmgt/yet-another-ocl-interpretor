...
public final class VariableExpValidationAdapter implements OCLAdapter {
  ...
  public Object getValue(EObject contextTarget) {
    throw new UnimplementedException("La methode getValue de VariableExpAdapter n'as pas encore été implémentée");
  }
  ...
  public OclAny getType() {
    throw new UnimplementedException("La methode getType de VariableExpAdapter n'as pas encore été implémentée");
  }
