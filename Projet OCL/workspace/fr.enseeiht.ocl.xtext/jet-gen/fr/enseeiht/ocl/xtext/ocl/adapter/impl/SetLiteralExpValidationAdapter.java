...
public final class SetLiteralExpValidationAdapter implements OCLAdapter {
  ...
  public Object getValue(EObject contextTarget) {
    throw new UnimplementedException("La methode getValue de SetLiteralExpAdapter n'as pas encore été implémentée");
  }
  ...
  public OclType getType() {
    throw new UnimplementedException("La methode getType de SetLiteralExpAdapter n'as pas encore été implémentée");
  }
