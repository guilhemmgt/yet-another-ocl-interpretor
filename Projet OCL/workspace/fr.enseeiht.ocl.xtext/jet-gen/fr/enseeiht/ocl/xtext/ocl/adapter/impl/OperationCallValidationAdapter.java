...
public final class OperationCallValidationAdapter implements OCLAdapter {
  ...
  public Object getValue(EObject contextTarget) {
    throw new UnimplementedException("La methode getValue de OperationCallAdapter n'as pas encore été implémentée");
  }
  ...
  public OCLType getType() {
    throw new UnimplementedException("La methode getType de OperationCallAdapter n'as pas encore été implémentée");
  }
