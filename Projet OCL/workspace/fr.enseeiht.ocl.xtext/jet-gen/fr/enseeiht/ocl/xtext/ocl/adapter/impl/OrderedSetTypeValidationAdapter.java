...
public final class OrderedSetTypeValidationAdapter implements OCLAdapter {
  ...
  public Object getValue(EObject contextTarget) {
    throw new UnimplementedException("La methode getValue de OrderedSetTypeAdapter n'as pas encore été implémentée");
  }
  ...
  public OclType getType() {
    throw new UnimplementedException("La methode getType de OrderedSetTypeAdapter n'as pas encore été implémentée");
  }
