...
public final class MapElementValidationAdapter implements OCLAdapter {
  ...
  public Object getValue(EObject contextTarget) {
    throw new UnimplementedException("La methode getValue de MapElementAdapter n'as pas encore été implémentée");
  }
  ...
  public OCLType getType() {
    throw new UnimplementedException("La methode getType de MapElementAdapter n'as pas encore été implémentée");
  }
