 ...
 * </p>
 * <ul>
 *   <li>{@link fr.enseeiht.ocl.xtext.ocl.impl.LetExpImpl#getVariable <em>Variable</em>}</li>
 *   <li>{@link fr.enseeiht.ocl.xtext.ocl.impl.LetExpImpl#getIn_ <em>In </em>}</li>
 * </ul>
 *
 * @generated
 */
public class LetExpImpl extends OclExpressionImpl implements LetExp
{
  ...
  public void setIn_(OclExpression newIn_)
  {
    if (newIn_ != in_)
    {
      ...
      if (newIn_ != null)
        msgs = ((InternalEObject)newIn_).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - OclPackage.LET_EXP__IN_, null, msgs);
