 ...
 * </p>
 * <ul>
 *   <li>{@link fr.enseeiht.ocl.xtext.ocl.impl.TupleTypeImpl#getAttributes <em>Attributes</em>}</li>
 * </ul>
 *
 * @generated
 */
public class TupleTypeImpl extends OclTypeImpl implements TupleType
{
  ...
  public EList<TupleTypeAttribute> getAttributes()
  {
    if (attributes == null)
    {
      attributes = new EObjectContainmentEList<TupleTypeAttribute>(TupleTypeAttribute.class, this, OclPackage.TUPLE_TYPE__ATTRIBUTES);
    }
    return attributes;
  }
