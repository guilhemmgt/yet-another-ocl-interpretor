...
public class OclSemanticSequencer extends AbstractDelegatingSemanticSequencer {
	 ...
	 *
	 * Constraint:
	 *     (model=[Import|ID] name=[EDataType|QualifiedName])
	 * </pre>
	 */
	protected void sequence_OclModelElementClass(ISerializationContext context, OclModelElementClass semanticObject) {
		...
		feeder.accept(grammarAccess.getOclModelElementClassAccess().getNameEDataTypeQualifiedNameParserRuleCall_2_0_1(), semanticObject.eGet(OclPackage.Literals.OCL_MODEL_ELEMENT_CLASS__NAME, false));
		feeder.finish();
	}
