...
public class OclSemanticSequencer extends AbstractDelegatingSemanticSequencer {
	...
	protected void sequence_VariableExp(ISerializationContext context, VariableExp semanticObject) {
		...
		SequenceFeeder feeder = createSequencerFeeder(context, semanticObject);
		feeder.accept(grammarAccess.getVariableExpAccess().getReferredVariableAuxiliaryIDTerminalRuleCall_0_0_1(), semanticObject.eGet(OclPackage.Literals.VARIABLE_EXP__REFERRED_VARIABLE, false));
		feeder.finish();
	}
