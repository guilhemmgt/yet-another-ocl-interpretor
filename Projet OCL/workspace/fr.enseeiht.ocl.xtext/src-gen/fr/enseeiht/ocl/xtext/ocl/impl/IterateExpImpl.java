 ...
 * </p>
 * <ul>
 *   <li>{@link fr.enseeiht.ocl.xtext.ocl.impl.IterateExpImpl#getIterators <em>Iterators</em>}</li>
 *   <li>{@link fr.enseeiht.ocl.xtext.ocl.impl.IterateExpImpl#getResult <em>Result</em>}</li>
 *   <li>{@link fr.enseeiht.ocl.xtext.ocl.impl.IterateExpImpl#getBody <em>Body</em>}</li>
 * </ul>
 *
 * @generated
 */
public class IterateExpImpl extends PropertyCallImpl implements IterateExp
{
  ...
  public EList<Iterator> getIterators()
  {
    if (iterators == null)
    {
      iterators = new EObjectContainmentEList<Iterator>(Iterator.class, this, OclPackage.ITERATE_EXP__ITERATORS);
    }
    return iterators;
  }
  ...
  public NotificationChain basicSetBody(OclExpression newBody, NotificationChain msgs)
  {
    ...
    if (eNotificationRequired())
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, OclPackage.ITERATE_EXP__BODY, oldBody, newBody);
      if (msgs == null) msgs = notification; else msgs.add(notification);
    }
    return msgs;
  }
  ...
  public void setBody(OclExpression newBody)
  {
    if (newBody != body)
    {
      NotificationChain msgs = null;
      if (body != null)
        msgs = ((InternalEObject)body).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - OclPackage.ITERATE_EXP__BODY, null, msgs);
      if (newBody != null)
        msgs = ((InternalEObject)newBody).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - OclPackage.ITERATE_EXP__BODY, null, msgs);
      msgs = basicSetBody(newBody, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, OclPackage.ITERATE_EXP__BODY, newBody, newBody));
  }
