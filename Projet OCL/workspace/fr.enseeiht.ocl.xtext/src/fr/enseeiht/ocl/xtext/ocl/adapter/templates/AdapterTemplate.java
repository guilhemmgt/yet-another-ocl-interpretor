...
public class AdapterTemplate
{
  ...
  protected final String TEXT_8 = " object) {" + NL + "\t\tthis.target = object;" + NL + "\t}" + NL + "" + NL + "\t/**" + NL + "\t * Returns the value of the element given its context" + NL + "\t * @param Target" + NL + "\t * @return value of the element" + NL + "\t * @generated" + NL + "\t */" + NL + "\tpublic Object getValue(EObject contextTarget) {" + NL + "\t\tthrow new UnimplementedException(this.getClass(),\"getValue\");" + NL + "\t}" + NL + "" + NL + "\t/**" + NL + "\t * Get the type of the element" + NL + "\t * @return type of the element" + NL + "\t * @generated" + NL + "\t */" + NL + "\tpublic OclType getType() {" + NL + "\t\tthrow new UnimplementedException(this.getClass(),\"getType\");" + NL + "\t}" + NL + "" + NL + "\t/**" + NL + "\t * @generated" + NL + "\t */" + NL + "\t @Override" + NL + "\tpublic String toString() {" + NL + "\t\treturn super.toString();" + NL + "\t}" + NL + "" + NL + "\t/**" + NL + "\t * Get adapted element" + NL + "\t * @return adapted element" + NL + "\t * @generated" + NL + "\t */" + NL + "\tpublic EObject getElement() {" + NL + "\t\treturn this.target;" + NL + "\t}" + NL + "" + NL + "\t/**" + NL + "\t * Return the string visible in the outline" + NL + "\t * @return outline name" + NL + "\t * @generated" + NL + "\t */" + NL + "\t @Override" + NL + "\tpublic String getOutlineString() {" + NL + "\t\treturn null;" + NL + "\t}" + NL + " }";
