...
public class AdapterTemplate
{
  ...
  protected final String TEXT_3 = ";" + NL + "import fr.enseeiht.ocl.xtext.OclAny;" + NL + "/**" + NL + " * OCLAdapter for ";
  ...
  protected final String TEXT_9 = "Adapter n'as pas encore été implémentée\");" + NL + "\t}" + NL + "" + NL + "\t/**" + NL + "\t * Get the type of the element" + NL + "\t * @return type of the element" + NL + "\t * @generated" + NL + "\t */" + NL + "\tpublic OclAny getType() {" + NL + "\t\tthrow new UnimplementedException(\"La methode getType de ";
