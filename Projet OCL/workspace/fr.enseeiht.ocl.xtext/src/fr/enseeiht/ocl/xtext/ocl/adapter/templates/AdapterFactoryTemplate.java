...
public class AdapterFactoryTemplate
{
  ...
  protected final String TEXT_18 = NL + "\tif (this.moduleAdapter == null) {" + NL + "\t\tthis.moduleAdapter = new ModuleValidationAdapter(target);" + NL + "\t}" + NL + "\treturn this.moduleAdapter;" + NL + "  \t";
