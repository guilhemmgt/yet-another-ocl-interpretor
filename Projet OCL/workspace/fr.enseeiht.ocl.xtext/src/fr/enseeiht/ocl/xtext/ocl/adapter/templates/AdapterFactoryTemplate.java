...
public class AdapterFactoryTemplate
{
  ...
  protected final String TEXT_17 = " target)" + NL + "  {" + NL + "\t";
  protected final String TEXT_18 = NL + "\tif (!this.moduleAdapters.containsKey(target)) {" + NL + "\t\tthis.moduleAdapters.put(target, new ModuleValidationAdapter(target));" + NL + "\t}" + NL + "\treturn this.moduleAdapters.get(target);\t" + NL + "  \t";
  protected final String TEXT_19 = NL + "    return new ";
  protected final String TEXT_20 = "ValidationAdapter(target);";
