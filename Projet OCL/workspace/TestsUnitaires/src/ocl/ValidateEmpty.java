...
public class ValidateEmpty {
	...
	private static void afficherResultat(ValidationResult resultat) {
			afficherErreurs("- Liar", resultat.getRecordedErrorsFor(EmptyPackage.LIAR));
			afficherErreurs("- Maybe", resultat.getRecordedErrorsFor(EmptyPackage.MAYBE));
			afficherErreurs("- SubLiar", resultat.getRecordedErrorsFor(EmptyPackage.SUB_LIAR));
	}
	...
	public static void main(String[] args) {
		...
		EmptyPackage packageInstance = EmptyPackage.eINSTANCE;
