...
class PetrinetTest {
	...
	static void setUpBeforeClass() throws Exception {
		...
		errorsMaps = LauncherUtils.run(workspacePath, "PetriNet-Guilhem-ok", "PetriNet.mocl", "PetriNet.ecore", "Network-blocage-EMF.xmi", "Network-developpement-EMF.xmi", "Network-patisserie-EMF.xmi", "Network-readarc.xmi", "Network-saisons.xmi");
	}
