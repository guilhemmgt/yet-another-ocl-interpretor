 ...
 * </p>
 * <ul>
 *   <li>{@link fr.enseeiht.xtext.tocl.tocl.impl.RealExpImpl#getRealSymbol <em>Real Symbol</em>}</li>
 * </ul>
 *
 * @generated
 */
public class RealExpImpl extends NumericExpImpl implements RealExp
{
  ...
  {
    return ToclPackage.Literals.REAL_EXP;
  }
  ...
  public void setRealSymbol(double newRealSymbol)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ToclPackage.REAL_EXP__REAL_SYMBOL, oldRealSymbol, realSymbol));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case ToclPackage.REAL_EXP__REAL_SYMBOL:
