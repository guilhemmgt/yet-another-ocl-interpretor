 ...
 * </p>
 * <ul>
 *   <li>{@link fr.enseeiht.xtext.tocl.tocl.impl.IntegerExpImpl#getIntegerSymbol <em>Integer Symbol</em>}</li>
 * </ul>
 *
 * @generated
 */
public class IntegerExpImpl extends NumericExpImpl implements IntegerExp
{
  ...
  {
    return ToclPackage.Literals.INTEGER_EXP;
  }
  ...
  public void setIntegerSymbol(int newIntegerSymbol)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ToclPackage.INTEGER_EXP__INTEGER_SYMBOL, oldIntegerSymbol, integerSymbol));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case ToclPackage.INTEGER_EXP__INTEGER_SYMBOL:
