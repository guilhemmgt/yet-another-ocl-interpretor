 ...
 * </p>
 * <ul>
 *   <li>{@link fr.enseeiht.xtext.tocl.tocl.impl.OrderedSetExpImpl#getElements <em>Elements</em>}</li>
 * </ul>
 *
 * @generated
 */
public class OrderedSetExpImpl extends OclExpressionImpl implements OrderedSetExp
{
  ...
  {
    return ToclPackage.Literals.ORDERED_SET_EXP;
  }
  ...
  public EList<OclExpression> getElements()
  {
    if (elements == null)
    {
      elements = new EObjectContainmentEList<OclExpression>(OclExpression.class, this, ToclPackage.ORDERED_SET_EXP__ELEMENTS);
    }
    return elements;
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case ToclPackage.ORDERED_SET_EXP__ELEMENTS:
