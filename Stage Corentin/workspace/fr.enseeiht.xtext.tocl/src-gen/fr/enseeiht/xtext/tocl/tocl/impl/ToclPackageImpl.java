 ...
 * @generated
 */
public class ToclPackageImpl extends EPackageImpl implements ToclPackage
{
  /**
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see fr.enseeiht.xtext.tocl.tocl.ToclPackage#eNS_URI
   * @see #init()
   * @generated
   */
  private ToclPackageImpl()
  {
    super(eNS_URI, ToclFactory.eINSTANCE);
  }
  /**
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   *
   * <p>This method is used to initialize {@link ToclPackage#eINSTANCE} when that field is accessed.
   ...
   * @generated
   */
  public static ToclPackage init()
  {
    if (isInited) return (ToclPackage)EPackage.Registry.INSTANCE.getEPackage(ToclPackage.eNS_URI);

    // Obtain or create and register package
    Object registeredToclPackage = EPackage.Registry.INSTANCE.get(eNS_URI);
    ToclPackageImpl theToclPackage = registeredToclPackage instanceof ToclPackageImpl ? (ToclPackageImpl)registeredToclPackage : new ToclPackageImpl();

    isInited = true;

    // Create package meta-data objects
    theToclPackage.createPackageContents();

    // Initialize created meta-data
    theToclPackage.initializePackageContents();

    // Mark meta-data to indicate it can't be changed
    theToclPackage.freeze();

    // Update the registry and return the package
    EPackage.Registry.INSTANCE.put(ToclPackage.eNS_URI, theToclPackage);
    return theToclPackage;
  }
   ...
   */
  @Override
  public ToclFactory getToclFactory()
  {
    return (ToclFactory)getEFactoryInstance();
  }
  ...
  public void initializePackageContents()
  {
    ...
    initEClass(moduleEClass, fr.enseeiht.xtext.tocl.tocl.Module.class, "Module", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
    initEAttribute(getModule_Name(), ecorePackage.getEString(), "name", null, 0, 1, fr.enseeiht.xtext.tocl.tocl.Module.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEReference(getModule_Imports(), this.getImport(), null, "imports", null, 0, -1, fr.enseeiht.xtext.tocl.tocl.Module.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEReference(getModule_Elements(), this.getModuleElement(), null, "elements", null, 0, -1, fr.enseeiht.xtext.tocl.tocl.Module.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
