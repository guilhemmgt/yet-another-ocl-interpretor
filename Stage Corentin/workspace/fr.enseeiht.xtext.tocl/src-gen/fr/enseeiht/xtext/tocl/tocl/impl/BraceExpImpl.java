 ...
 * </p>
 * <ul>
 *   <li>{@link fr.enseeiht.xtext.tocl.tocl.impl.BraceExpImpl#getExp <em>Exp</em>}</li>
 * </ul>
 *
 * @generated
 */
public class BraceExpImpl extends OclExpressionImpl implements BraceExp
{
  ...
  {
    return ToclPackage.Literals.BRACE_EXP;
  }
  ...
  public NotificationChain basicSetExp(OclExpression newExp, NotificationChain msgs)
  {
    ...
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, ToclPackage.BRACE_EXP__EXP, oldExp, newExp);
  ...
  public void setExp(OclExpression newExp)
  {
    if (newExp != exp)
    {
      ...
      if (exp != null)
        msgs = ((InternalEObject)exp).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - ToclPackage.BRACE_EXP__EXP, null, msgs);
      if (newExp != null)
        msgs = ((InternalEObject)newExp).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - ToclPackage.BRACE_EXP__EXP, null, msgs);
      msgs = basicSetExp(newExp, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ToclPackage.BRACE_EXP__EXP, newExp, newExp));
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case ToclPackage.BRACE_EXP__EXP:
