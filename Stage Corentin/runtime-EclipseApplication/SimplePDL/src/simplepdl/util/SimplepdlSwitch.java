...
public class SimplepdlSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case SimplepdlPackage.RESOURCE_NEEDED: {
				ResourceNeeded resourceNeeded = (ResourceNeeded)theEObject;
				T result = caseResourceNeeded(resourceNeeded);
				if (result == null) result = caseProcessElement(resourceNeeded);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Resource Needed</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Resource Needed</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseResourceNeeded(ResourceNeeded object) {
		return null;
	}
