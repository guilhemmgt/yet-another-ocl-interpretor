...
public interface SimplepdlPackage extends EPackage {
	...
	/**
	 * The meta object id for the '{@link simplepdl.impl.ResourceNeededImpl <em>Resource Needed</em>}' class.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see simplepdl.impl.ResourceNeededImpl
	 * @see simplepdl.impl.SimplepdlPackageImpl#getResourceNeeded()
	 * @generated
	 */
	int RESOURCE_NEEDED = 6;
	 ...
	 * @ordered
	 */
	int RESOURCE_NEEDED__QUANTITY = PROCESS_ELEMENT_FEATURE_COUNT + 0;

	/**
	 * The feature id for the '<em><b>Link To WD</b></em>' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 * @ordered
	 */
	int RESOURCE_NEEDED__LINK_TO_WD = PROCESS_ELEMENT_FEATURE_COUNT + 1;

	/**
	 * The feature id for the '<em><b>Takes</b></em>' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 * @ordered
	 */
	int RESOURCE_NEEDED__TAKES = PROCESS_ELEMENT_FEATURE_COUNT + 2;

	/**
	 * The number of structural features of the '<em>Resource Needed</em>' class.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 * @ordered
	 */
	int RESOURCE_NEEDED_FEATURE_COUNT = PROCESS_ELEMENT_FEATURE_COUNT + 3;

	/**
	 * The number of operations of the '<em>Resource Needed</em>' class.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 * @ordered
	 */
	int RESOURCE_NEEDED_OPERATION_COUNT = PROCESS_ELEMENT_OPERATION_COUNT + 0;
	...
	/**
	 * Returns the meta object for class '{@link simplepdl.ResourceNeeded <em>Resource Needed</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for class '<em>Resource Needed</em>'.
	 * @see simplepdl.ResourceNeeded
	 * @generated
	 */
	EClass getResourceNeeded();

	/**
	 * Returns the meta object for the attribute '{@link simplepdl.ResourceNeeded#getQuantity <em>Quantity</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the attribute '<em>Quantity</em>'.
	 * @see simplepdl.ResourceNeeded#getQuantity()
	 * @see #getResourceNeeded()
	 * @generated
	 */
	EAttribute getResourceNeeded_Quantity();

	/**
	 * Returns the meta object for the reference '{@link simplepdl.ResourceNeeded#getLinkToWD <em>Link To WD</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the reference '<em>Link To WD</em>'.
	 * @see simplepdl.ResourceNeeded#getLinkToWD()
	 * @see #getResourceNeeded()
	 * @generated
	 */
	EReference getResourceNeeded_LinkToWD();

	/**
	 * Returns the meta object for the reference '{@link simplepdl.ResourceNeeded#getTakes <em>Takes</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the reference '<em>Takes</em>'.
	 * @see simplepdl.ResourceNeeded#getTakes()
	 * @see #getResourceNeeded()
	 * @generated
	 */
	EReference getResourceNeeded_Takes();
	...
	interface Literals {
		...
		/**
		 * The meta object literal for the '{@link simplepdl.impl.ResourceNeededImpl <em>Resource Needed</em>}' class.
		 * <!-- begin-user-doc -->
		 * <!-- end-user-doc -->
		 * @see simplepdl.impl.ResourceNeededImpl
		 * @see simplepdl.impl.SimplepdlPackageImpl#getResourceNeeded()
		 * @generated
		 */
		EClass RESOURCE_NEEDED = eINSTANCE.getResourceNeeded();
		 ...
		 * @generated
		 */
		EAttribute RESOURCE_NEEDED__QUANTITY = eINSTANCE.getResourceNeeded_Quantity();

		/**
		 * The meta object literal for the '<em><b>Link To WD</b></em>' reference feature.
		 * <!-- begin-user-doc -->
		 * <!-- end-user-doc -->
		 * @generated
		 */
		EReference RESOURCE_NEEDED__LINK_TO_WD = eINSTANCE.getResourceNeeded_LinkToWD();

		/**
		 * The meta object literal for the '<em><b>Takes</b></em>' reference feature.
		 * <!-- begin-user-doc -->
		 * <!-- end-user-doc -->
		 * @generated
		 */
		EReference RESOURCE_NEEDED__TAKES = eINSTANCE.getResourceNeeded_Takes();
