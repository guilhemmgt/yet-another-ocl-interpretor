...
public class SimplepdlPackageImpl extends EPackageImpl implements SimplepdlPackage {
	 ...
	 * @generated
	 */
	private EClass resourceNeededEClass = null;
	 ...
	 */
	@Override
	public EClass getResourceNeeded() {
		return resourceNeededEClass;
	}
	 ...
	 */
	@Override
	public EAttribute getResourceNeeded_Quantity() {
		return (EAttribute)resourceNeededEClass.getEStructuralFeatures().get(0);
	}
	 ...
	 */
	@Override
	public EReference getResourceNeeded_LinkToWD() {
		return (EReference)resourceNeededEClass.getEStructuralFeatures().get(1);
	}
	 ...
	 */
	@Override
	public EReference getResourceNeeded_Takes() {
		return (EReference)resourceNeededEClass.getEStructuralFeatures().get(2);
	}
	...
	public void createPackageContents() {
		...
		resourceNeededEClass = createEClass(RESOURCE_NEEDED);
		createEAttribute(resourceNeededEClass, RESOURCE_NEEDED__QUANTITY);
		createEReference(resourceNeededEClass, RESOURCE_NEEDED__LINK_TO_WD);
		createEReference(resourceNeededEClass, RESOURCE_NEEDED__TAKES);
	...
	public void initializePackageContents() {
		...
		resourceNeededEClass.getESuperTypes().add(this.getProcessElement());
		...
		initEReference(getWorkDefinition_Need(), this.getResourceNeeded(), this.getResourceNeeded_LinkToWD(), "need", null, 0, -1, WorkDefinition.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEAttribute(getResource_Total(), ecorePackage.getEInt(), "total", null, 1, 1, Resource.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(resourceNeededEClass, ResourceNeeded.class, "ResourceNeeded", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEAttribute(getResourceNeeded_Quantity(), ecorePackage.getEInt(), "quantity", null, 1, 1, ResourceNeeded.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getResourceNeeded_LinkToWD(), this.getWorkDefinition(), this.getWorkDefinition_Need(), "linkToWD", null, 1, 1, ResourceNeeded.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getResourceNeeded_Takes(), this.getResource(), null, "takes", null, 1, 1, ResourceNeeded.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
