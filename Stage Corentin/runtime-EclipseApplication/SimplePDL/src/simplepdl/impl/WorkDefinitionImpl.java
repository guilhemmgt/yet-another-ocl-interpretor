...
public class WorkDefinitionImpl extends ProcessElementImpl implements WorkDefinition {
	 ...
	 * @ordered
	 */
	protected EList<ResourceNeeded> need;
	 ...
	 */
	@Override
	public EList<ResourceNeeded> getNeed() {
		if (need == null) {
			need = new EObjectWithInverseResolvingEList<ResourceNeeded>(ResourceNeeded.class, this, SimplepdlPackage.WORK_DEFINITION__NEED, SimplepdlPackage.RESOURCE_NEEDED__LINK_TO_WD);
		}
		return need;
	}
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			...
			case SimplepdlPackage.WORK_DEFINITION__NEED:
				getNeed().clear();
				getNeed().addAll((Collection<? extends ResourceNeeded>)newValue);
				return;
		}
