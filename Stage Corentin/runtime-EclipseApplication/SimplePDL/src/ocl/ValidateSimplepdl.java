...
public class ValidateSimplepdl {
	...
	private static void afficherResultat(ValidationResult resultat) {
			...
			afficherErreurs("- ProcessElement", resultat.getRecordedErrorsFor(SimplepdlPackage.PROCESS_ELEMENT));
			afficherErreurs("- Resource", resultat.getRecordedErrorsFor(SimplepdlPackage.RESOURCE));
			afficherErreurs("- ResourceNeeded", resultat.getRecordedErrorsFor(SimplepdlPackage.RESOURCE_NEEDED));
	}
