...
public class ValidatePetrinet {
	...
	private static void afficherResultat(ValidationResult resultat) {
			afficherErreurs("- Net", resultat.getRecordedErrorsFor(PetrinetPackage.NET));
			afficherErreurs("- NetElement", resultat.getRecordedErrorsFor(PetrinetPackage.NET_ELEMENT));
			...
			afficherErreurs("- Bloc", resultat.getRecordedErrorsFor(PetrinetPackage.BLOC));
	}
