...
public class ValidateTest {
	...
	private static void afficherResultat(ValidationResult resultat) {
			afficherErreurs("- Entreprise", resultat.getRecordedErrorsFor(TestPackage.ENTREPRISE));
			afficherErreurs("- Employe", resultat.getRecordedErrorsFor(TestPackage.EMPLOYE));
	}
