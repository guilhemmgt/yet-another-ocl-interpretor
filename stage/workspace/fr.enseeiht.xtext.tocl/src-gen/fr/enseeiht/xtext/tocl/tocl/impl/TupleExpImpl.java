 ...
 * </p>
 * <ul>
 *   <li>{@link fr.enseeiht.xtext.tocl.tocl.impl.TupleExpImpl#getTuplePart <em>Tuple Part</em>}</li>
 * </ul>
 *
 * @generated
 */
public class TupleExpImpl extends OclExpressionImpl implements TupleExp
{
  ...
  {
    return ToclPackage.Literals.TUPLE_EXP;
  }
  ...
  public EList<TuplePart> getTuplePart()
  {
    if (tuplePart == null)
    {
      tuplePart = new EObjectContainmentEList<TuplePart>(TuplePart.class, this, ToclPackage.TUPLE_EXP__TUPLE_PART);
    }
    return tuplePart;
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case ToclPackage.TUPLE_EXP__TUPLE_PART:
