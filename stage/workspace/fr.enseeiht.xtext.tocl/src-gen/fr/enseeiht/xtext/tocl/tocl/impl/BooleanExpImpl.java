 ...
 * </p>
 * <ul>
 *   <li>{@link fr.enseeiht.xtext.tocl.tocl.impl.BooleanExpImpl#getBooleanSymbol <em>Boolean Symbol</em>}</li>
 * </ul>
 *
 * @generated
 */
public class BooleanExpImpl extends OclExpressionImpl implements BooleanExp
{
  ...
  {
    return ToclPackage.Literals.BOOLEAN_EXP;
  }
  ...
  public void setBooleanSymbol(String newBooleanSymbol)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ToclPackage.BOOLEAN_EXP__BOOLEAN_SYMBOL, oldBooleanSymbol, booleanSymbol));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case ToclPackage.BOOLEAN_EXP__BOOLEAN_SYMBOL:
