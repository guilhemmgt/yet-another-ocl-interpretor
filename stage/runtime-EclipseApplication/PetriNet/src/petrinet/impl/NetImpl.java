 ...
 *   <li>{@link petrinet.impl.NetImpl#getNetElements <em>Net Elements</em>}</li>
 * </ul>
 *
 * @generated
 */
public class NetImpl extends MinimalEObjectImpl.Container implements Net {
	...
	public EList<NetElement> getNetElements() {
		if (netElements == null) {
			netElements = new EObjectContainmentWithInverseEList<NetElement>(NetElement.class, this, PetrinetPackage.NET__NET_ELEMENTS, PetrinetPackage.NET_ELEMENT__NET);
		}
		return netElements;
	}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case PetrinetPackage.NET__NET_ELEMENTS:
				return ((InternalEList<InternalEObject>)(InternalEList<?>)getNetElements()).basicAdd(otherEnd, msgs);
		}
