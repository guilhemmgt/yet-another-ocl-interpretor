...
public class SimplepdlFactoryImpl extends EFactoryImpl implements SimplepdlFactory {
	...
	public EObject create(EClass eClass) {
		switch (eClass.getClassifierID()) {
			...
			case SimplepdlPackage.RESOURCE_NEEDED: return createResourceNeeded();
			default:
	 ...
	 */
	@Override
	public ResourceNeeded createResourceNeeded() {
		ResourceNeededImpl resourceNeeded = new ResourceNeededImpl();
